...
public class CustomTokenResponseConverter implements Converter<Map<String, String>, OAuth2AccessTokenResponse> {
    ...
    public OAuth2AccessTokenResponse convert(Map<String, String> tokenResponseParameters) {
        ...
        String refreshTokenExpiresIn = tokenResponseParameters.get("refresh_token_expires_in");
        ...
        if(!StringUtils.isEmpty(refreshTokenExpiresIn)) {
            additionalParameters.put("refresh_token_expires_in", Long.parseLong(refreshTokenExpiresIn));
        }
